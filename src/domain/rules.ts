...
export const RULE_IDS = [
  ...
  "delivery.merge-commits-disabled",
  "delivery.rebase-merging-disabled",
  "delivery.update-branches-suggested",
...
export const RULE_DEFINITIONS: readonly RuleDefinition[] = [
  ...
  DEFINITION(
    ...
    "Pull requests cannot be merged with a merge commit, keeping the repository on a squash-only merge policy.",
    "Disable Allow merge commits in the repository pull request settings.",
    5,
    "medium",
  ),
  DEFINITION(
    ...
    "Pull requests cannot be merged by rebasing, keeping the repository on a squash-only merge policy.",
    "Disable Allow rebase merging in the repository pull request settings.",
    5,
    "medium",
  ),
  DEFINITION(
    "delivery.update-branches-suggested",
    "delivery_hygiene",
    "Pull request branch updates suggested",
    "GitHub suggests updating pull request branches when they fall behind the base branch.",
    "Enable Always suggest updating pull request branches in the repository pull request settings.",
    5,
    "medium",
  ),
  DEFINITION(
