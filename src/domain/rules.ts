...
export const RULE_DEFINITIONS: readonly RuleDefinition[] = [
  ...
  DEFINITION(
    ...
    "The default branch has guardrails such as required reviews and passing checks.",
    "Protect the default branch and require the appropriate review and status checks.",
    30,
    "critical",
  ),
  DEFINITION(
  ...
  DEFINITION(
    ...
    "Changes to the default branch require meaningful review and successful checks.",
    "Require pull requests, at least one review, and passing required checks on the default branch.",
    18,
    "high",
  ),
  DEFINITION(
